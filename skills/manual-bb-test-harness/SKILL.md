...
EC、注文、決済、在庫、キャンセル、返金が主題なら `references/domain-pack-ec.md` も読む。B2B SaaS、workspace、role、permission、invitation、audit log が主題なら `references/domain-pack-saas-rbac.md` も読む。
